...
const SLIDES: LawSlide[] = [
  {
    ...
    lawCopy:
      "这颗星球保存着一条来自人类纪元的判断。它谈的并不只是“累了就走”，而是更古老也更难回答的问题：一个原本能够休息、恢复、重新回到正常节奏的人，会不会有一天失去这种能力。",
    reality:
      "为了读懂这句话，我们先不急着翻开那些留下来的声音。先看支配这颗星球的法则——动力系统中的鞍结分岔。它讲述的，恰好是一种“原本存在的稳定，如何走到尽头”。",
    tone: "climax",
    diagram: "overview",
  },
  {
